...
class GoodsSpider():
    ...
    def crawl_goods(self, live_id: str) -> list:
        headers = {
    ...
    def crawl_anchor_id(self) -> str:
        ...
        anchor_id = res.json()["data"]["anchorId"]
        return anchor_id
